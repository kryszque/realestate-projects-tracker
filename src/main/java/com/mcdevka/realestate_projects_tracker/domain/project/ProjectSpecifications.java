...
public class ProjectSpecifications {
    public static Specification<Project> createSearch(SearchingCriteria criteria, User user) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            if(user.getRole() != Role.ADMIN) {
                if(user.getCompany() == null){
                    ...
                    predicates.add(criteriaBuilder.equal(root.get("companyResponsible"), user.getCompany()));
                }
            }
